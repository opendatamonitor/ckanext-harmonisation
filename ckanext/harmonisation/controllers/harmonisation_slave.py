...
handler = logging.FileHandler('/var/local/ckan/default/pyenv/src/ckanext-harmonisation/ckanext/harmonisation/controllers/harmonisation.log')
...
## harmonise basics
	  if 'harmonised' in harmonise_job.keys():
		...
		job['harmonisation'].update({"message_HarmoniseTags":str(message_HarmoniseTags)})
		job['harmonisation'].update({"message_HarmoniseExtras":str(message_HarmoniseExtras)})
		job['harmonisation'].update({"message_HarmoniseStringsToIntegers":str(message_HarmoniseStringsToIntegers)})
		job['harmonisation'].update({"harmonised_basic":"finished"})
		job['harmonisation'].update({"harmonised_basic_date":datetime.now()})
		jobs.save(job)
...
## harmonise dates
	  if 'dates' in harmonise_job.keys():
		...
		cat_url=harmonise_job['cat_url']
		message_HarmoniseDatesLabels=HarmonisationEngine.HarmoniseDatesLabels(cat_url)
		message_HarmoniseReleaseDates=HarmonisationEngine.HarmoniseReleaseDates(cat_url)
	  ...
	  ## update to jobs db
		...
		job['harmonisation'].update({"message_HarmoniseDatesLabels":str(message_HarmoniseDatesLabels)})
		job['harmonisation'].update({"message_HarmoniseReleaseDates":str(message_HarmoniseReleaseDates)})
		job['harmonisation'].update({"message_HarmoniseUpdateDates":str(message_HarmoniseUpdateDates)})
		job['harmonisation'].update({"message_HarmoniseMetadataCreated":str(message_HarmoniseMetadataCreated)})
		job['harmonisation'].update({"message_HarmoniseMetadataModified":str(message_HarmoniseMetadataModified)})
		job['harmonisation'].update({"harmonised_dates_date":datetime.now()})
		jobs.save(job)
...
##harmonise licenses
	...
	## update to jobs db
		...
		job['harmonisation'].update({"message_HarmoniseLicenses":str(message_HarmoniseLicenses)})
		job['harmonisation'].update({"harmonised_licenses_date":datetime.now()})
		jobs.save(job)
