    ...
    def main_dashboard(self, data=None):
      ...
      # unharmonise
        ...
        if unharmonise_action == 'unharmonise-catalogue':
            ...
            document_job = collection_jobs.find_one(
                {"title": str(data['catalogue_selection'])})
      ...
      # view info
        ...
        if info_action == 'get-catalogue-info':
            ...
            try:
                harmonised_basic = document[
                    'harmonisation']['harmonised_basic']
            except KeyError:
                harmonised_basic = "unharmonised"

            try:
                harmonised_basic_date = document[
                    'harmonisation']['harmonised_basic_date']
            except KeyError:
                harmonised_basic_date = ""

            try:
                message_HarmoniseTags = document[
                    'harmonisation']['message_HarmoniseTags']
            except KeyError:
                message_HarmoniseTags = ""

            try:
                message_Copy_Odm_to_Odm_harmonised = document[
                    'harmonisation']['message_Copy_Odm_to_Odm_harmonised']
            except KeyError:
                message_Copy_Odm_to_Odm_harmonised = ""

            try:
                message_HarmoniseExtras = document[
                    'harmonisation']['message_HarmoniseExtras']
            except KeyError:
                message_HarmoniseExtras = ""

            try:
                message_HarmoniseStringsToIntegers = document[
                    'harmonisation']['message_HarmoniseStringsToIntegers']
            except KeyError:
                message_HarmoniseStringsToIntegers = ""

            try:
                message_HarmoniseDatesLabels = document[
                    'harmonisation']['message_HarmoniseDatesLabels']
            except KeyError:
                message_HarmoniseDatesLabels = ""

            try:
                message_HarmoniseReleaseDates = document[
                    'harmonisation']['message_HarmoniseReleaseDates']
            except KeyError:
                message_HarmoniseReleaseDates = ""

            try:
                message_HarmoniseUpdateDates = document[
                    'harmonisation']['message_HarmoniseUpdateDates']
            except KeyError:
                message_HarmoniseUpdateDates = ""

            try:
                message_HarmoniseMetadataCreated = document[
                    'harmonisation']['message_HarmoniseMetadataCreated']
            except KeyError:
                message_HarmoniseMetadataCreated = ""

            try:
                message_HarmoniseMetadataModified = document[
                    'harmonisation']['message_HarmoniseMetadataModified']
            except KeyError:
                message_HarmoniseMetadataModified = ""

            try:
                harmonised_dates = document[
                    'harmonisation']['harmonised_dates']
            except KeyError:
                harmonised_dates = "unharmonised"

            try:
                harmonised_dates_date = document[
                    'harmonisation']['harmonised_dates_date']
            except KeyError:
                harmonised_dates_date = ""

            try:
                harmonised_resources = document[
                    'harmonisation']['harmonised_resources']
            except KeyError:
                harmonised_resources = "unharmonised"

            try:
                message_HarmoniseBadFormats = document[
                    'harmonisation']['message_HarmoniseBadFormats']
            except KeyError:
                message_HarmoniseBadFormats = ""

            try:
                message_HarmoniseMimetypes = document[
                    'harmonisation']['message_HarmoniseMimetypes']
            except KeyError:
                message_HarmoniseMimetypes = ""

            try:
                message_HarmoniseSizes = document[
                    'harmonisation']['message_HarmoniseSizes']
            except KeyError:
                message_HarmoniseSizes = ""

            try:
                message_HarmoniseFormats = document[
                    'harmonisation']['message_HarmoniseFormats']
            except KeyError:
                message_HarmoniseFormats = ""

            try:
                message_HarmoniseNumTagsAndResources = document[
                    'harmonisation']['message_HarmoniseNumTagsAndResources']
            except KeyError:
                message_HarmoniseNumTagsAndResources = ""

            try:
                harmonised_resources_date = document[
                    'harmonisation']['harmonised_resources_date']
            except KeyError:
                harmonised_resources_date = ""

            try:
                harmonised_licenses = document[
                    'harmonisation']['harmonised_licenses']
            except KeyError:
                harmonised_licenses = "unharmonised"

            try:
                message_HarmoniseLicenses = document[
                    'harmonisation']['message_HarmoniseLicenses']
            except KeyError:
                message_HarmoniseLicenses = ""

            try:
                harmonised_licenses_date = document[
                    'harmonisation']['harmonised_licenses_date']
            except KeyError:
                harmonised_licenses_date = ""

            try:
                harmonised_languages = document[
                    'harmonisation']['harmonised_languages']
            except KeyError:
                harmonised_languages = "unharmonised"

            try:
                message_HarmoniseLanguageLabels = document[
                    'harmonisation']['message_HarmoniseLanguageLabels']
            except KeyError:
                message_HarmoniseLanguageLabels = ""

            try:
                message_HarmoniseLanguages = document[
                    'harmonisation']['message_HarmoniseLanguages']
            except KeyError:
                message_HarmoniseLanguages = ""

            try:
                harmonised_languages_date = document[
                    'harmonisation']['harmonised_languages_date']
            except KeyError:
                harmonised_languages_date = ""

            try:
                harmonised_categories = document[
                    'harmonisation']['harmonised_categories']
            except KeyError:
                harmonised_categories = "unharmonised"

            try:
                message_HarmoniseCategoryLabels = document[
                    'harmonisation']['message_HarmoniseCategoryLabels']
            except KeyError:
                message_HarmoniseCategoryLabels = ""

            try:
                message_HarmoniseCategories = document[
                    'harmonisation']['message_HarmoniseCategories']
            except KeyError:
                message_HarmoniseCategories = ""

            try:
                harmonised_categories_date = document[
                    'harmonisation']['harmonised_categories_date']
            except KeyError:
                harmonised_categories_date = ""

            try:
                harmonised_countries = document[
                    'harmonisation']['harmonised_countries']
            except KeyError:
                harmonised_countries = "unharmonised"

            try:
                harmonised_countries_date = document[
                    'harmonisation']['harmonised_countries_date']
            except KeyError:
            ...
            data[
                'message_HarmoniseNumTagsAndResources'] = message_HarmoniseNumTagsAndResources
            ...
            if data['catalogue_selection'] != "All my catalogues":
                ...
                # print('+* storing *+')
                    ...
                    while j < len(document.keys()):
                        ...
                        document1.update({document.keys()[j]: document[
                                         unicode(document.keys()[j])]})
                ...
                while i < len(document.keys()):
                    if document.keys()[i] != '_id' and document.keys()[
                            i] != 'cat_url' and document.keys()[i] != 'user':
...
# view mappings
        ...
        db = client.odm
# per catalogue - case
        if "catalogue_selection" in data and data[
                'catalogue_selection'] != "All my catalogues":
            if 'Select Rules Category' in data.keys():
                ...
                data['harmonise_category_selection'] = data[
                    'Select Rules Category']
...
# Case - per catalogue
            if data['catalogue_selection'] != "All my catalogues":
                ...
                try:
                    document = collection_new.find_one(
                        {'cat_url': str(cat_url)})
                    if data['new_key'] != "":
                    ...
                    try:
                        ...
                        if 'unharmonised_value' in data.keys()[i]:
                            if data[str(data.keys()[i])] != "":
                                ...
                                document.update(
                                    {temp_key: data[str(data.keys()[i])]})
                                document.update({'cat_url': cat_url})
                                document.update({'user': c.user})
                                collection_new.save(document)
                                # remove from unharmonised
                                document_unharm = collection_unharmonised.find_one(
                                    {'cat_url': str(cat_url)})
                                if document_unharm is not None:
                                    #print('trying to delete')
                                    del document_unharm[str(temp_key)]
                                    collection_unharmonised.save(
                                        document_unharm)
                        i += 1
                    except:
                        if 'unharmonised_value' in data.keys()[i]:
